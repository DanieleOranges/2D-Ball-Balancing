...
## Generated on : Thu Nov 11 17:27:59 2021
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/user/Desktop/2D-Ball-Balancing/lab06
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -I$(START_DIR)/untitled_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=untitled -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/untitled_grt_rtw/rtGetInf.c $(START_DIR)/untitled_grt_rtw/rtGetNaN.c $(START_DIR)/untitled_grt_rtw/rt_nonfinite.c $(START_DIR)/untitled_grt_rtw/untitled.c $(START_DIR)/untitled_grt_rtw/untitled_data.c rt_logging.c $(MATLAB_ROOT)/rtw/c/src/common/rt_main.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj untitled.obj untitled_data.obj rt_logging.obj
...
%.obj : $(START_DIR)/untitled_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
