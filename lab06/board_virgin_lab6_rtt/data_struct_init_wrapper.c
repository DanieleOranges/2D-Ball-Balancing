...
/*
volatile Motor_T Motor[2] = {	{PIN_M1_ENABLE, PIN_M1_PWM1_R3, PIN_M1_PWM2_R3, PIN_M1_CURRENT, PIN_M1_6V, PIN_M1_12V, PIN_M1_24V}, 
				{PIN_M2_ENABLE, PIN_M2_PWM1_R3, PIN_M2_PWM2_R3, PIN_M2_CURRENT, PIN_M2_6V, PIN_M2_12V, PIN_M2_24V}
};
*/
/* Mod 03/03/2017 Andrea Costa - Old Board Rev 2
...
if (xD[0]!=1) {
    ...
    # ifndef MATLAB_MEX_FILE
        ...
        int SWCFG0, SWCFG1, SWCFG2;
        
        /* Change ADC and DAC resolution */
        analogWriteResolution(12);
        analogReadResolution(12);
        
        /* Board revision pins */
        pinMode(PIN_SWCFG0, INPUT);
        pinMode(PIN_SWCFG1, INPUT);
        pinMode(PIN_SWCFG2, INPUT);

        /* Set board revision pins pullup */
        pinMode(PIN_SWCFG0, INPUT_PULLUP);
        pinMode(PIN_SWCFG1, INPUT_PULLUP);
        pinMode(PIN_SWCFG2, INPUT_PULLUP);
        
        /* Get board revision */
        SWCFG0 = digitalRead(PIN_SWCFG0);
        SWCFG1 = digitalRead(PIN_SWCFG1);
        SWCFG2 = digitalRead(PIN_SWCFG2);

        /* Setup PWM motor pins */
        if ((SWCFG0 == HIGH) && (SWCFG1 == HIGH) && (SWCFG2 == HIGH))
        {
            // If rev 2
            BoardRev = 2;
        }
        else if ((SWCFG0 == LOW) && (SWCFG1 == HIGH) && (SWCFG2 == HIGH))
        {
            // If rev 3
            BoardRev = 3;
        }
        ...
        if (BoardRev == 2)
        {
            pinMode(PIN_M1_PWM1_R2, OUTPUT);
            pinMode(PIN_M1_PWM2_R2, OUTPUT);
            pinMode(PIN_M2_PWM1_R2, OUTPUT);
            pinMode(PIN_M2_PWM2_R2, OUTPUT);

            Motor[0].enable   = PIN_M1_ENABLE;
            Motor[0].PWM1     = PIN_M1_PWM1_R2;
            Motor[0].PWM2     = PIN_M1_PWM2_R2;
            Motor[0].current  = PIN_M1_CURRENT;
            Motor[0].m6v      = PIN_M1_6V;
            Motor[0].m12v     = PIN_M1_12V;
            Motor[0].m24v     = PIN_M1_24V;

            Motor[1].enable   = PIN_M2_ENABLE;
            Motor[1].PWM1     = PIN_M2_PWM1_R2;
            Motor[1].PWM2     = PIN_M2_PWM2_R2;
            Motor[1].current  = PIN_M2_CURRENT;
            Motor[1].m6v      = PIN_M2_6V;
            Motor[1].m12v     = PIN_M2_12V;
            Motor[1].m24v     = PIN_M2_24V;
        }
        else if (BoardRev == 3)
        {
            pinMode(PIN_M1_PWM1_R3, OUTPUT);
            pinMode(PIN_M1_PWM2_R3, OUTPUT);
            pinMode(PIN_M2_PWM1_R3, OUTPUT);
            pinMode(PIN_M2_PWM2_R3, OUTPUT);
            
            Motor[0].enable   = PIN_M1_ENABLE;
            Motor[0].PWM1     = PIN_M1_PWM1_R3;
            Motor[0].PWM2     = PIN_M1_PWM2_R3;
            Motor[0].current  = PIN_M1_CURRENT;
            Motor[0].m6v      = PIN_M1_6V;
            Motor[0].m12v     = PIN_M1_12V;
            Motor[0].m24v     = PIN_M1_24V;
            ...
            Motor[1].enable   = PIN_M2_ENABLE;
            Motor[1].PWM1     = PIN_M2_PWM1_R3;
            Motor[1].PWM2     = PIN_M2_PWM2_R3;
            Motor[1].current  = PIN_M2_CURRENT;
            Motor[1].m6v      = PIN_M2_6V;
            Motor[1].m12v     = PIN_M2_12V;
            Motor[1].m24v     = PIN_M2_24V;
