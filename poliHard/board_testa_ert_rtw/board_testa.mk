###########################################################################
## Makefile generated for component 'board_testa'. 
## 
## Makefile     : board_testa.mk
## Generated on : Mon Dec 13 16:30:10 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/board_testa.elf
...
PRODUCT_NAME              = board_testa
MAKEFILE                  = board_testa.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/ricci/Desktop/PROGET~1/2D-BAL~2/poliHard
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                   = C:/Users/ricci/DOCUME~1/MATLAB/R2021b/ARDUIN~1/ARDUIN~2/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/board_testa.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=8 -DMW_TIMERCOUNT=65625 -DMW_SAM_CLOCKID=TC_CMR_TCCLKS_TIMER_CLOCK4 -DARDUINO_NUM_SERIAL_PORTS=4 -D_RTT_BAUDRATE_SERIAL0_=19200 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=19200 -D_RTT_BAUDRATE_SERIAL3_=19200 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=board_testa -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o ProtocolDecoderUtilities.o MW_SerialRead.o MW_SerialWrite.o board_testa.o board_testa_data.o callback.o arm_m3_cortex_handler.o MW_ArduinoHWInit.o io_wrappers.o arduinoARMScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/board_testa_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/board_testa_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/board_testa_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/board_testa_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/board_testa_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/script/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/script/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/script/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/script/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
board_testa.o : $(START_DIR)/board_testa_ert_rtw/board_testa.c
	$(CC) $(CFLAGS) -o "$@" "$<"


board_testa_data.o : $(START_DIR)/board_testa_ert_rtw/board_testa_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/board_testa_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


callback.o : $(START_DIR)/script/callback.c
	$(CC) $(CFLAGS) -o "$@" "$<"
