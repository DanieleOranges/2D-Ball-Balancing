 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri Dec 03 10:46:32 2021
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                double2ascii
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 double_input
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                array_output
...
extern void double2ascii_Outputs_wrapper(const int32_T *double_input,
...
{
  const int32_T *double_input = (int32_T *) ssGetInputPortRealSignal(S, 0);
  uint8_T *array_output = (uint8_T *) ssGetOutputPortRealSignal(S, 0);
  double2ascii_Outputs_wrapper(double_input, array_output);
}
